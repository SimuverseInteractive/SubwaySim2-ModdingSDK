...
--
-- SWSModding_MainSignal data table
--
--
...
local dataTable = {
	contentType		= "signal",
	contentName		= "SWSModding_MainSignalTunnel_SGRYSYG",
	...
	components		= {
		...
		-- {	name	= "D_DestinationU",		componentName	= "TopScreen_U",			},
		-- {	name	= "D_DestinationA",		componentName	= "TopScreen_A",			},
		-- {	name	= "D_DestinationZ",		componentName	= "TopScreen_Z",			},
