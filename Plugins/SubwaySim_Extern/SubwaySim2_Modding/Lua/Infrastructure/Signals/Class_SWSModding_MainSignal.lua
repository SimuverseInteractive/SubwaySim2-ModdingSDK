...
--
-- SubwaySim
-- Module SWSModding_MainSignal.lua
--
-- SWSModding_MainSignal functionality
--
--
...
---@class SWSModding_MainSignal : MainSignal
SWSModding_MainSignal = Class("SWSModding_MainSignal", SWSModding_MainSignal, MainSignal);
...
function SWSModding_MainSignal:onTrainHasPassed(trigger, trainComposition, trainPart)
	...
	SWSModding_MainSignal:parentClass().onTrainHasPassed(self, trigger, trainComposition, trainPart);
end;
